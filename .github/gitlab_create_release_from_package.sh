...
# Delete existing asset links only after the target package version and its files
# have been resolved successfully. This avoids stripping a release on failed reruns.
